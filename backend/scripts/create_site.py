...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-ploneconf2025.core:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-ploneconf2025.core:initial")
        transaction.commit()
    app._p_jar.sync()
